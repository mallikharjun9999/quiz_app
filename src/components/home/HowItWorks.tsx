...
export const HowItWorks: React.FC = () => {
  const steps = [
    {
      ...
      title: "Follow these simple steps to start your quiz journey today!",
      description: "Log in to access a wide range of quizzes tailored for you.",
      actionText: "Start",
    ...
    },
    {
      ...
      title:
        "Complete quizzes at your own pace and track your progress effortlessly.",
      description:
        "Receive instant feedback on your performance to enhance your learning.",
      actionText: "Track",
    ...
    },
    {
      ...
      title:
        "Engage with various categories to broaden your knowledge and skills.",
      description:
        "Choose from General Knowledge, Technical, and Science quizzes to challenge yourself.",
      actionText: "Explore",
  ...
  return (
    <section className="bg-[rgba(236,230,231,1)] flex w-full flex-col overflow-hidden items-stretch px-16 py-28 max-md:max-w-full max-md:px-5 max-md:py-[100px]">
      <h2 className="text-black text-center text-[40px] font-normal leading-[48px] tracking-[-0.4px] self-center w-[768px] max-md:max-w-full">
        Discover how our quiz platform makes learning fun and easy.
      </h2>
